...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{teo}
        \item[$\bullet$] \begin{teo}
            Si una varietat Riemanniana tancada de dimensió $n$ té una immersió o incrustació $C^\infty$ en $E^{k}$ amb $k\ge n+2$, aleshores també té una immersió o incrustació, respectivament, isomètrica en $E^{k}$.
        \end{teo}
        \item[$\bullet$] \begin{teo}
            Si una varietat Riemanniana oberta de dimensió $n$ té una immersió o incrustació $C^\infty$ curta en $E^{k}$ amb $k\ge n+2$ que no se solapa amb el seu conjunt límit (si aquest existeix), aleshores també té una immersió o incrustació, respectivament, isomètrica en $E^{k}$ del mateix tipus.
        \end{teo}
    \end{itemize}
