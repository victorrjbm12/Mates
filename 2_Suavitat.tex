...
\begin{defi}
    Un \textbf{camp vectorial} $X$ al llarg d'una corba $\sigma:[a,b]\to M$ és una aplicació $X:[a,b]\to T(M)$ que \say{aixeca} un vector, és a dir, tal que $\pi\circ X = \sigma$, on $\pi$ és la projecc
\end{defi}
