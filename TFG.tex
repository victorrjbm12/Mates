...
Per la compacitat d' $h(D)\subseteq\mathcal P$, {\color{blue} Per què?} existeix un nombre finit de sumands que són funcions no-nul·les{\color{blue} Non-vanishing, mirar la traducció}. Reanomenem aquests sumands d'aquesta manera:
\begin{equation*}
